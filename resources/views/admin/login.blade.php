...
<div class="bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 max-w-md w-full">
    ...
    <div class="space-y-3 mb-6">
        ...
        <a href="{{ route('admin.oauth.redirect', 'google') }}"
           class="flex items-center justify-center gap-3 w-full bg-white hover:bg-gray-100 text-gray-800 font-medium py-3 px-4 rounded-lg transition">
        ...
        <a href="{{ route('admin.oauth.redirect', 'github') }}"
           class="flex items-center justify-center gap-3 w-full bg-gray-900 hover:bg-gray-950 text-white font-medium py-3 px-4 rounded-lg transition border border-gray-700">
    ...
    <div class="relative mb-6">
        ...
        <div class="relative flex justify-center text-sm">
            <span class="px-4 bg-gray-800/80 text-gray-400">or login with password</span>
        </div>
    </div>
    @endif
