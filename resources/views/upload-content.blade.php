...
<div class="max-w-md w-full">
    <div class="bg-gray-800/80 backdrop-blur rounded-lg p-5 sm:p-8 shadow-xl">
        ...
        <form action="{{ route('upload.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="border-2 border-dashed border-gray-600 rounded-lg p-6 sm:p-8 text-center hover:border-blue-500 transition-colors cursor-pointer" onclick="document.getElementById('file-input').click()">
                ...
                <p id="file-name" class="mt-2 text-sm text-blue-400 hidden break-all px-1"></p>
            </div>

            <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded-lg transition-colors min-h-12">
                Upload File
            </button>
        </form>
